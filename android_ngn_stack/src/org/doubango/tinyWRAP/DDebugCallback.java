...
public class DDebugCallback {
  ...
  public int OnDebugDebug(String message) {
    return (getClass() == DDebugCallback.class) ? tinyWRAPJNI.DDebugCallback_OnDebugDebug(swigCPtr, this, message) : tinyWRAPJNI.DDebugCallback_OnDebugDebugSwigExplicitDDebugCallback(swigCPtr, this, message);
  }
