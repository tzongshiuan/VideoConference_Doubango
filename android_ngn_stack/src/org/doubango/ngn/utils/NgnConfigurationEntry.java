...
public class NgnConfigurationEntry {
	...
	//	Identity
	public static final String DEFAULT_IDENTITY_DISPLAY_NAME = "hsuan2";
	public static final String DEFAULT_IDENTITY_IMPU = "sip:11902@192.168.11.26";
	public static final String DEFAULT_IDENTITY_IMPI = "hsuan2";
	...
	public static final String DEFAULT_NETWORK_REALM = "192.168.11.26";
	...
	public static final String DEFAULT_NETWORK_PCSCF_HOST = "192.168.11.26";
	...
	public static final String DEFAULT_NATT_STUN_SERVER = "10.1.62.113";
	public static final int DEFAULT_NATT_STUN_PORT = 3478;
	public static final String DEFAULT_NATT_STUN_USERNAME = "gorilla";
	public static final String DEFAULT_NATT_STUN_PASSWORD = "gorillakm";
