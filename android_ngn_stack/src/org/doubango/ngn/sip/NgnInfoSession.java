...
public class NgnInfoSession extends NgnSipSession {
	...
	public static NgnInfoSession buildinfosession(NgnSipStack sipStack){
		final NgnInfoSession avSession = new NgnInfoSession(sipStack);
		return avSession;
	}

	public int send(ByteBuffer buff,long len ) {
		mSession.send(buff,len);
		return 0;
	}
	@Override
