...
public class NgnSipStack extends SipStack{
	...
	public void setCommandType(String message)
	{
		super.addHeader("Command",message);
	}
	public void setAppendMssage(String message)
	{
		super.addHeader("AppendMessage",message);
	}
