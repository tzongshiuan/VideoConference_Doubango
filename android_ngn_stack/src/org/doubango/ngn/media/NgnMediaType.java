...
public enum NgnMediaType {
	...
	AudioVideoSecondary(Audio.getValue() | Video.getValue() | SecondaryVideo.getValue()),
	...
	private static class media_type_bind_s {
		...
		private static media_type_bind_s[] __media_type_binds =  {
			...
			new media_type_bind_s(NgnMediaType.SecondaryVideo, twrap_media_type_t.twrap_media_secondary_video),
        };
